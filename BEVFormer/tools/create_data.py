...
# PYTHONPATH=/root/autodl-tmp/ADMM-Diff/BEVFormer:/root/autodl-tmp/ADMM-Diff/BEVFormer/tools:$PYTHONPATH
# python tools/create_data.py nuscenes --root-path /root/autodl-tmp/nuscenes --canbus /root/autodl-tmp/nuscenes --out-dir /root/autodl-tmp/nuscenes --extra-tag nuscenes --version v1.0 --max-sweeps 10
# 此处在源代码执行时会报错，原因是tools没有被识别为包，应建立init.py，然后pythonpath引入tools的父路径，
# export PYTHONPATH=/root/autodl-tmp/ADMM-Diff/BEVFormer:$PYTHONPATH 即可。
