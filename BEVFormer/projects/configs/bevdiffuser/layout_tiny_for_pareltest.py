...
info_root = "/root/autodl-fs/nuscenes/pkl_for_uniad/mini_pkl_for_uniad/" #mini_pkl_for_uniad/
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=info_root + 'nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=info_root + 'nuscenes_infos_temporal_val.pkl',
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='BEVDiffuser_tiny_train',  # 项目名，自行修改
                name='BEVDiffuser_tiny_train_exp1',  # 实验名，自行修改
                notes='total_same_as_original_version',  # 可选说明
                tags=['bevdiffuser','bev_tiny']
            )),
