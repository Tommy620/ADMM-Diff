...
# admmdenoiser = dict(
#     type='projects.bevdiffuser.layout_diffusion.layout_diffusion_admmdenoiser.LayoutDiffusionUNetModel', #BEVFormer.
#     parameters=dict(
#         image_size=bev_h_,
#         use_fp16=False,
...
info_root = os.environ.get(
    "NUSCENES_INFO_ROOT",
    "/root/autodl-tmp/nuscenes/pkl_4_bevdiffuser/pkl_4_bevdiffuser_mini/",
