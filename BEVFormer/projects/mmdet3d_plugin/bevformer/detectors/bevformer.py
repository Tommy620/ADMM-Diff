...
class BEVFormer(MVXTwoStageDetector):
    ...
    def forward_pts_train(
        ...
        outs = self.pts_bbox_head(pts_feats, img_metas, prev_bev, given_bev=given_bev)
    ...
    def forward_test(
        ...
        **kwargs,
        ...
        if only_bev:
            new_prev_bev = self.simple_test_bev(
    ...
    def simple_test_pts(
        self, x, img_metas, prev_bev=None, given_bev=None, rescale=False
    ):
        """Test function"""
    ...
    def simple_test(
        ...
        **kwargs,
        ...
        """Test function without augmentaiton."""  # list装着1个20键dict；img（6，3，480，800）
        img_feats = self.extract_feat(
            img=img, img_metas=img_metas
        )  # list装着一个1，6，256，15，25的张量
    ...
    def simple_test_loss(
        self, img_metas, img=None, prev_bev=None, given_bev=None, **kwargs
    ):
        img_feats = self.extract_feat(img=img, img_metas=img_metas)
        outs = self.pts_bbox_head(
            img_feats, img_metas, prev_bev=prev_bev, given_bev=given_bev
        )
